...
m = TCN(nb_filters=5, kernel_size=3,  nb_stacks=1, padding='causal', use_skip_connections=True, dropout_rate=0.3, return_sequences=False, name='tcn')(i)
...
print('Train...')
history = model.fit(x, y, validation_split= 0.2,  epochs=500, verbose=2)
